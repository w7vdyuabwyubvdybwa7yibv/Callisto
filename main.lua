--!strict
--[[
    Aether + Callisto – Hybrid UI Library
    - GUI structure, theming, configs, keybinds → Aether
    - Slider + Checkbox (smooth, no size changes) → Callisto
    Single‑file, production‑ready.
]]

--=============================================================================
-- Service cache & environment (Aether)
--=============================================================================
...
getgenv().Library = {
    Directory = "Ultimate",
    Folders = {
        "/Fonts", "/Configs", "/Themes", "/Hitsounds"
    },
    Flags = {},
    ConfigFlags = {},
    Connections = {},
...
do
    ...
    for Theme, _ in Themes.Preset do
        if Theme == "Font" then continue end
    ...
    Library.Fade = function(self, obj, prop, vis)
        ...
        Library:Connect(Animation.Completed, function()
            if not vis then obj[prop] = OldTransparency end
        end)
        return Animation
    end
    ...
    Library.TweenDescendants = function(self, Bool, Path)
        ...
        if Path.Tweening then return end
        local Instance = self.Instance
        Path.Tweening = true
        if Bool then Instance.Visible = true end
    ...
    Library.Resizify = function(self)
        ...
        local Size, InputLost, ParentSize = Instance.Size
    ...
    Library.Hovering = function(self)
        local y = self.Instance.AbsolutePosition.Y <= Mouse.Y and Mouse.Y <= self.Instance.AbsolutePosition.Y + self.Instance.AbsoluteSize.Y
        local x = self.Instance.AbsolutePosition.X <= Mouse.X and Mouse.X <= self.Instance.AbsolutePosition.X + self.Instance.AbsoluteSize.X
        return y and x
    end
    ...
    Library.Draggify = function(self)
        ...
        local InitialSize, InitialPosition
    ...
    Library.OnHover = function(self, Callback1, Callback2)
        ...
        Library:Connect(self.Instance.MouseEnter, Callback1)
        Library:Connect(self.Instance.MouseLeave, Callback2)
    end
    ...
    Library.OutsideClick = function(self, Cfg)
        local Connection = Library:Connect(Services.UserInputService.InputBegan, function(input)
            if self.Instance.Visible == false then return end
    ...
    Library.Create = function(self, Class, Options)
        ...
        for Property, Value in Options do
    ...
    Library.Blurify = function(self, Strength)
        ...
        table.insert(Library.Blurs, self)
    ...
    Library.CreateWindow = function(self, Data)
        ...
        Library:Create("UIScale", { Parent = Items.Menu.Instance, Scale = 0.65 })
        ...
        Items.Menu:Draggify()
        Items.Menu:Resizify()
        Library:Create("UICorner", { Parent = Items.Menu.Instance, CornerRadius = UDim.new(0, 10) })
        Library:Create("UIStroke", { Parent = Items.Menu.Instance, Transparency = 0.5 })
        ...
        Library:Create("UICorner", { Parent = Items.SideBar.Instance, CornerRadius = UDim.new(0, 10) })
        ...
        Items.KeybindList = Library:Create("Frame", {
            ...
            Position = UDim2.new(0, 37, 0, 401),
            BorderSizePixel = 0,
            ZIndex = 2,
            BackgroundColor3 = Color3.fromRGB(20, 20, 22),
        })
        Library:Create("UIStroke", { Color = Color3.fromRGB(23, 24, 27), Parent = Items.KeybindList.Instance })
        Library:Create("UIPadding", {
        ...
        Library:Create("UICorner", { Parent = Items.KeybindList.Instance })
        ...
        Library:Create("ImageLabel", {
            ...
            Image = "rbxassetid://97239058232142",
            BackgroundTransparency = 1,
        ...
        Items.KeybindHolder = Library:Create("Frame", {
            ZIndex = 0,
            Parent = Items.KeybindList.Instance,
        ...
        Library:Create("UICorner", { Parent = Items.KeybindHolder.Instance })
        Library:Create("UIPadding", {
        ...
        Library:Create("UIStroke", { Color = Color3.fromRGB(23, 24, 27), Parent = Items.KeybindHolder.Instance })
        ...
        Items.ModList = Library:Create("Frame", {
            ...
            Parent = Library.HUD.Instance,
            Size = UDim2.new(0, 200, 0, 31),
            Position = UDim2.new(0, 37 + 200 + 10, 0, 401),
            BorderSizePixel = 0,
            ZIndex = 2,
            BackgroundColor3 = Color3.fromRGB(20, 20, 22),
        })
        Library:Create("UIStroke", { Color = Color3.fromRGB(23, 24, 27), Parent = Items.ModList.Instance })
        Library:Create("UIPadding", {
            PaddingTop = UDim.new(0, 2),
            PaddingBottom = UDim.new(0, 2),
        ...
        Library:Create("UICorner", { Parent = Items.ModList.Instance })
        local Title2 = Library:Create("TextLabel", {
            LayoutOrder = 1,
            TextColor3 = Color3.fromRGB(245, 245, 245),
            Text = "Mods",
            Parent = Items.ModList.Instance,
        ...
        Library:Create("ImageLabel", {
            ...
            Size = UDim2.new(0, 18, 0, 18),
            AnchorPoint = Vector2.new(1, 0),
            Image = "rbxassetid://74208295465261",
            BackgroundTransparency = 1,
            Position = UDim2.new(1, -5, 0, 5),
            ZIndex = 2,
            BorderSizePixel = 0,
        ...
        Items.ModHolder = Library:Create("Frame", {
            ZIndex = 0,
            Parent = Items.ModList.Instance,
            Size = UDim2.new(0, 200, 0, 0),
            Position = UDim2.new(0, -2, 0, 18),
        ...
        Library:Create("UICorner", { Parent = Items.ModHolder.Instance })
        Library:Create("UIPadding", {
            PaddingTop = UDim.new(0, 18),
            PaddingBottom = UDim.new(0, 2),
            Parent = Items.ModHolder.Instance,
            PaddingRight = UDim.new(0, 2),
            PaddingLeft = UDim.new(0, 2),
        })
        Library:Create("UIStroke", { Color = Color3.fromRGB(23, 24, 27), Parent = Items.ModHolder.Instance })
        ...
        Library:Create("UICorner", { Parent = Items.Watermark.Instance })
        ...
        function Cfg.SetVisible(Bool)
            ...
            if not Cfg.SizeVector then return end
            ...
            Items.Menu:Tween({ Size = Bool and UDim2.new(0, Cfg.SizeVector.X, 0, Cfg.SizeVector.Y) or UDim2.new(0, 70, 0, 70) })
    ...
    Library.AddTab = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.Button.Instance, CornerRadius = UDim.new(0, 6) })
        Library:Create("ImageLabel", {
        ...
        Library:Create("UICorner", { Parent = Items.Glow.Instance, CornerRadius = UDim.new(0, 3) })
        ...
        Library:Create("UICorner", { Parent = Items.Background.Instance, CornerRadius = UDim.new(0, 6) })
        ...
        Library:Create("UICorner", { Parent = Items.Holder.Instance })
        ...
        for _, Page in Cfg.Pages do
            ...
            local MiscItems = PageData.Items
            -- Subtab button
            ...
            Library:Create("UICorner", { Parent = MiscItems.Button.Instance, CornerRadius = UDim.new(0, 6) })
            ...
            PageData.OpenPage = function()
                ...
                if OldTab == PageData then return end
                if PageData.Tweening or (OldTab and OldTab.Tweening) then return end
                if OldTab then
            ...
            MiscItems.Page:Reparent(Items.MainPage.Instance)
            ...
            table.insert(Cfg.Sections, setmetatable(PageData, Library))
        end

        Cfg.OpenPage = function()
            local OldTab = self.TabInfo
            if OldTab == Cfg then return end
            if Cfg.Tweening or (OldTab and OldTab.Tweening) then return end
            if OldTab then
    ...
    Library.AddSection = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.Section.Instance, CornerRadius = UDim.new(0, 6) })
        Library:Create("UIStroke", {
        ...
        Cfg.UpdateSection = function(Instance)
            task.spawn(function()
                if not Cfg.Collapsed then
                    Cfg.CachedSize = Cfg.CachedSize + Instance.AbsoluteSize.Y + 13
    ...
    Library.AddToggle = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.Toggle.Instance, CornerRadius = UDim.new(1, 0) })
        ...
        Library:Create("UICorner", { Parent = Items.Circle.Instance, CornerRadius = UDim.new(1, 0) })
    ...
    -- Checkbox (Callisto) – square with tick, no size changes
    Library.AddCheckbox = function(self, Data)
        Data = Data or {}
        local Cfg = {
            Text = Data.Text or "Checkbox",
            Flag = Data.Flag or Data.Name or Data.Text or "Checkbox",
            Enabled = Data.Default or false,
            Callback = Data.Callback or function() end,
            Items = {},
        }
        ...
        Library:Create("UICorner", { Parent = Items.Box.Instance, CornerRadius = UDim.new(0, 3) })
        Items.BoxStroke = Library:Create("UIStroke", {
            Color = Themes.Preset.Inline,
        ...
        Library:Create("UICorner", { Parent = Items.Fill.Instance, CornerRadius = UDim.new(0, 3) })
        Items.FillStroke = Library:Create("UIStroke", {
            Color = Themes.Preset.Accent,
            Transparency = 1,
        ...
        Cfg.Set = function(bool)
            Cfg.Enabled = bool
            local info = TweenInfo.new(Library.TweeningSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut)
            Services.TweenService:Create(Items.Fill.Instance, info, { BackgroundTransparency = bool and 0 or 1 }):Play()
            Services.TweenService:Create(Items.FillStroke.Instance, info, { Transparency = bool and 0 or 1 }):Play()
            Services.TweenService:Create(Items.BoxStroke.Instance, info, { Transparency = bool and 1 or 0 }):Play()
            Services.TweenService:Create(Items.Tick.Instance, info, { ImageTransparency = bool and 0 or 1 }):Play()
            Services.TweenService:Create(Items.Tick.Instance, bool and TweenInfo.new(Library.TweeningSpeed, Enum.EasingStyle.Back, Enum.EasingDirection.Out) or TweenInfo.new(Library.TweeningSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), { Rotation = bool and 0 or -60 }):Play()
            Items.Text:Tween({ TextColor3 = bool and Themes.Preset.TextColor or Themes.Preset.Unselected })
            Flags[Cfg.Flag] = bool
            Cfg.Callback(bool)
        end
    ...
    -- Slider (Callisto) – smooth drag, fill bar, no size tween
    Library.AddSlider = function(self, Data)
        ...
        local container = Library:Create("Frame", {
            ...
            AutomaticSize = Enum.AutomaticSize.Y,
            BorderSizePixel = 0,
            LayoutOrder = self.Items.Elements.Instance:FindFirstChildWhichIsA("UIListLayout") and #self.Items.Elements.Instance:GetChildren() or 0,
        })
        Library:Create("UIListLayout", { Parent = container.Instance, Padding = UDim.new(0, 5) })
        ...
        Library:Create("UIPadding", { Parent = title.Instance, PaddingTop = UDim.new(0, -3), PaddingBottom = UDim.new(0, -1) })

        local current = Library:Create("TextLabel", {
            Parent = textHolder.Instance,
            LayoutOrder = 1,
            Text = "0" .. suffix,
            TextColor3 = Themes.Preset.TextColor,
        ...
        Library:Create("UIPadding", { Parent = current.Instance, PaddingTop = UDim.new(0, -3), PaddingBottom = UDim.new(0, -1) })
        ...
        Library:Create("UICorner", { Parent = track.Instance, CornerRadius = UDim.new(0, 5) })
        ...
        Library:Create("UICorner", { Parent = fill.Instance, CornerRadius = UDim.new(0, 5) })
        Library:Create("UIStroke", {
            Color = Themes.Preset.Accent,
        ...
        if shadow then
            shadow.Instance.Color = Themes.Preset.Accent
            Library:Themify(shadow, "Accent", "Color")
        end
        ...
        local function render()
            ...
            fill.Instance.Size = UDim2.new(progress, 0, 1, 0) -- instant, no tween
            current.Instance.Text = tostring(round(value)) .. suffix
        end

        local function set(newValue, silent)
            value = math.clamp(round(newValue), minimum, maximum)
            render()
            if Data.Flag then Flags[Data.Flag] = value end
        ...
        local function updateFromInput(position)
            local progress = math.clamp((position.X - track.Instance.AbsolutePosition.X) / track.Instance.AbsoluteSize.X, 0, 1)
        ...
        -- Hover feedback (stroke tint)
        track.Instance.MouseEnter:Connect(function()
            trackStroke.Instance.Color = Themes.Preset.Accent
        end)
        track.Instance.MouseLeave:Connect(function()
            trackStroke.Instance.Color = Themes.Preset.Inline
        end)

        set(value, true)
        self.UpdateSection(container.Instance)
        ConfigFlags[Data.Flag] = set
        return {
    ...
    --=========================================================================
    -- Remaining Aether elements: Button, Label, Dropdown, KeyPicker, ColorPicker, Input, List
    -- (Copied from Aether with minimal changes)
    --=========================================================================
    ...
    Library.AddButton = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.Outline.Instance, CornerRadius = UDim.new(0, 5) })
        ...
        Library:Create("UICorner", { Parent = Items.Accent.Instance, CornerRadius = UDim.new(0, 5) })
    ...
    Library.AddDropdown = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.DropdownHolder.Instance, CornerRadius = UDim.new(0, 5) })
        Library:Create("UIPadding", {
            PaddingTop = UDim.new(0, 2),
            PaddingBottom = UDim.new(0, 1),
            Parent = Items.DropdownHolder.Instance,
        ...
        Cfg.RenderOption = function(text)
            ...
            Library:Create("UICorner", { Parent = DropdownItems.Button.Instance, CornerRadius = UDim.new(0, 5) })
    ...
    Library.AddKeyPicker = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.Holder2.Instance, CornerRadius = UDim.new(0, 5) })
        Items.Value = Library:Create("TextLabel", {
            FontFace = Themes.Preset.Font,
            TextColor3 = Color3.fromRGB(252, 252, 252),
            Text = "RightShift",
    ...
    -- AddColorPicker (reuses Keypicker)
    Library.AddColorPicker = function(self, Data)
        ...
        -- Use the Keypicker mechanism with color parameters
        local Picker = self:Keypicker({
            Text = Cfg.Text,
            Flag = Cfg.Flag,
    ...
    Library.AddList = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.ScrollingFrame.Instance, CornerRadius = UDim.new(0, 3) })
        Library:Create("UICorner", { Parent = Items.Inline.Instance, CornerRadius = UDim.new(0, 3) })
        ...
        Cfg.RenderOption = function(name)
            ...
            Button:OnHover(
                function()
                    ...
                    Button:Tween({ TextColor3 = Themes.Preset.Accent })
                end,
                function()
                    if Flags[Cfg.Flag] == Button.Instance.Text or (type(Flags[Cfg.Flag]) == "table" and table.find(Flags[Cfg.Flag], Button.Instance.Text)) then
                        return
    ...
    Library.Notify = function(self, Data)
        ...
        Library:Create("UICorner", { Parent = Items.Notification.Instance })
    ...
    Library.LerpObjects = function(self)
        ...
        for _, Object in self.Notifications.Notifs do
            if not Object.Fade then Object.Fade = 2 end
            ...
            YOffset = YOffset + (Instance.AbsoluteSize.Y + 6) * (Object.Fade / 255)
        end
    end
    ...
    --=========================================================================
    -- Keybind and Mod floating lists (Aether)
    --=========================================================================

    -- AddHotKey (for keybind list)
    Library.AddHotKey = function(self, Data)
        ...
        local Items = Cfg.Items
        Items.Keybind = Library:Create("CanvasGroup", {
            Parent = self.Window.Items.KeybindHolder.Instance,
            BackgroundTransparency = 1,
    ...
    Library.LerpKeybinds = function(self)
        ...
        for _, Object in self.Keybinds do
            ...
            YOffset = YOffset + (Instance.AbsoluteSize.Y) * (Object.Fade / 255)
    ...
    Library.AddMod = function(self, Data)
        ...
        local Items = Cfg.Items
        Items.Mod = Library:Create("CanvasGroup", {
            Parent = self.Window.Items.ModHolder.Instance,
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 25),
            BorderSizePixel = 0,
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    --=========================================================================
    -- Main loop for notifications, keybinds, mods
    --=========================================================================

    Library:Connect(Services.RunService.Heartbeat, function()
        if not (Library.LerpObjects and Library.LerpKeybinds and Library.LerpMods) then
            return
        end
        Library:LerpObjects()
    ...
    --=========================================================================
    -- Configs & Theming UI (Aether's settings tab)
    --=========================================================================
    ...
    Library.InitConfigs = function(self, Window)
        ...
        local ConfigText
        local ConfigHolder = Section:AddDropdown({
            Text = "Configs",
            Flag = "ConfigList",
            Callback = function(option)
        ...
        Section:AddButton({
            Text = "Save",
            Callback = function()
                if not ConfigText then return end
